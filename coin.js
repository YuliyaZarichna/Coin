...
function init() {
    ...
    var coin = new THREE.CylinderGeometry(coinWidth, coinWidth, coinThikness, numberOfVerticies);
    ...
    var displacementBack = textureLoader.load('textures/projects_displacement.jpg')

    var coinMaterials = [
        new THREE.MeshPhongMaterial({ color: 0xcccccc }),
        new THREE.MeshPhongMaterial({ map: textureBack, bumpMap: bumpBack, displacementMap: displacementBack,  displacementScale: 0.01}),
        new THREE.MeshPhongMaterial({ map: textureFront, bumpMap: bumpFront, displacementMap: displacementFont, displacementScale: 0.01 }),
    ]
